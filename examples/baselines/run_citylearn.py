...
`datasets/citylearn/<env_name>/<dataset_quality>/`
"""
...
flags.DEFINE_string("base_dataset_dir", "datasets/city_learn", "Directory with tfrecord files.")
flags.DEFINE_string("dataset_quality", "Replay", "E.g. Replay")
flags.DEFINE_string("env_name", "2022_all_phases", "E.g. case33_3min")
...
def main(_):
    ...
    environment_factory = functools.partial(city_learn.CityLearn)
