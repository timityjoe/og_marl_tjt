...
`datasets/smac_v2/<env_name>/<dataset_quality>/`
"""
...
flags.DEFINE_string("env_name", "terran_5_vs_5", "Env name.")
...
def main(_):
    ...
    print(f"{FLAGS.base_dataset_dir}/{FLAGS.env_name}/{FLAGS.dataset_quality}")

    system._max_trainer_steps = 50_001
