...
class IQLBCQSystemBuilder(IQLSystemBuilder):
    def __init__(
        self,
        environment_factory,
        logger_factory,
        ...
        super().__init__(
            ...
            max_replay_size=max_replay_size,  # num episodes in buffer (online)
            ...
            trajectories_per_file=trajectories_per_file,  # Number of sequences per file in offline dataset
        ...
        self._trainer_fn = IQLBCQTrainer
    ...
    def _build_trainer(
        ...
        trainer = self._trainer_fn(
            ...
            q_network=q_network,
            optimizer=self._optimizer,
            behaviour_cloning_network=self._behaviour_cloning_network,
            discount=self._discount,
            target_update_rate=self._target_update_rate,
            lambda_=self._lambda,
            dataset=dataset,
